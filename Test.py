...
#extr = Extractor("resources/ideal-images/Testfälle/falsche Testfälle/21.png")
#extr = Extractor("resources/ideal-images/Testfälle/falsche Testfälle/22.png")
#extr = Extractor("resources/ideal-images/Testfälle/falsche Testfälle/23.png")
#extr = Extractor("resources/ideal-images/Testfälle/falsche Testfälle/24.png")
#extr = Extractor("resources/ideal-images/Testfälle/falsche Testfälle/25.png")
