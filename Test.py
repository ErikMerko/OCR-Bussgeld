...
# pdf2image.convert_from_path("resources/ideal-images/TestbilderWordSerienbriefe/BußgeldbescheidKonstanzTest.pdf", fmt='png', dpi='600', output_folder="resources/ideal-images/TestbilderWordSerienbriefe")
...
# extr = Extractor(r"resources\ideal-images\TestbilderWordSerienbriefe\ZwickauTestNr1.png")
