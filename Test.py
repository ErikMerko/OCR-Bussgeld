...
#pdf2image.convert_from_path("resources/ideal-images/TestbilderWordSerienbriefe/BußgeldbescheidZwickauTest.pdf", fmt='png', dpi='600', output_folder="resources/ideal-images/TestbilderWordSerienbriefe")
